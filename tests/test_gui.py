...
class TestModelDetailPanel:
    ...
    def test_context_k_and_kv_display_map_to_runtime_values(
        ...
        # Advanced is a six-row form, not four explanatory Configure buttons.
        assert set(panel._capability_status) == {
            "vision_status", "mtp_status", "dflash_status", "ngram_status",
            "backend_sampling_status", "metrics_status"}
        ...
        # sampling and metrics on Advanced.
        ...
        panel._vars["metrics"].set("On")
        panel._commit_metrics()
        ...
        assert ("demo", {"server.metrics": True}) in changes
